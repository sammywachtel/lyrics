import { $createSectionParagraphNode, $isSectionParagraphNode, SectionParagraphNode } from '../../../../src/components/lexical/nodes/SectionParagraphNode'
import { $createTextNode, $getRoot, type EditorConfig } from 'lexical'
import { createTestEditor } from '../../../../src/components/utils/testUtils'
