...
describe('apiSlice', () => {
  ...
  describe('hooks', () => {
    it('should export query hooks', () => {
      const { useGetSongsQuery, useGetSongQuery, useHealthCheckQuery } = require('../../../src/store/api/apiSlice')
    ...
    it('should export mutation hooks', () => {
      ...
      } = require('../../../src/store/api/apiSlice')
    ...
    it('should export lazy query hooks', () => {
      const { useLazyGetSongsQuery, useLazyGetSongQuery } = require('../../../src/store/api/apiSlice')
