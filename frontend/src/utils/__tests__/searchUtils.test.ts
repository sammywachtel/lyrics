...
// Define Song type locally to avoid import issues
interface Song {
  id: string
  user_id: string
  title: string
...
// Mock createDefaultSettings function
const createDefaultSettings = () => ({
  narrative_pov: 'first_person',
  structural_boxes: [],
  section_structure: [],
  rhyme_preferences: { primary_types: [], allow_slant_rhymes: true, emphasis_on_perfect: false },
  prosody_settings: { rhythmic_stability: 0.5, phrasing_style: 'balanced', syllable_emphasis: false, meter_consistency: 0.5 },
  keyword_settings: { primary_keywords: [], metaphor_themes: [] },
  style_guide: { voice_guidelines: '', prohibited_words: [] },
  six_best_friends: {}
})
